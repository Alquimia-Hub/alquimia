...
function TalkCardBody({ id }: { id: TalkId }) {
...
function ComingSoonCard() {
  const t = useTranslations("Talks.soon");
  ...
  return (
    ...
    >
      <CarouselContent className="-ml-5 py-1">
        {TALKS.map((talk) => {
          const title = t(`items.${talk.id}.title`);
